...
def boa205_course_announcements_new_announcement():
    ...
    return render_template('boa205_course/es_announcements/boa205_course_create_announcement.html', title='New announcement', form=form)
...
def announcement(announcement_id):
    ...
    return render_template('boa205_course/es_announcements/boa205_course_announcement.html', title=announcement.title, announcement=announcement, func=read_image)
...
def update_announcement(announcement_id):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Tu announcement ha sido actualizado!', 'success')
        return redirect(url_for('boa205_course.boa205_course_home'))
    elif request.method == 'GET':
        form.title.data = announcement.title
        form.content.data = announcement.content
    return render_template('boa205_course/es_announcements/boa205_course_create_announcement.html', title='Update announcement',
...
def user_announcements(username):
    ...
    return render_template('boa205_course/es_announcements/boa205_course_user_announcements.html', announcements=announcements, user=user, func=read_image)
