            ...
            <div class="container_spot_go"> 
                <div class="menu_left">
                    ...
                    <div class="menu">
                        <ul class="nav">
                            <li class="nav-item">
                                <a href="/redispatch/">App-Paper</a> 
                            </li>
                            <li class="nav-item">
                                <a href="#">Chat</a> 
                            </li>
                            <li class="nav-item">
                                <a href="#">Students-Questions</a> 
                            </li>
                            <li class="nav-item">
                                <a href="#">Students-Answers</a> 
                            </li>
                            <li class="nav-item">
                                <a href="#">Calendar</a> 
                            </li>
                            ...
                            <div class="d-sm-flex align-items-center justify-content-between">
                              <div class="col-lg-7 col-md-7 col-sm-6 col-12">
                                ...
                                <div class="container_buttons_links_header">
                                    <div class="btn">
                                        <a href="#" class="btn btn-primary btn-lg mr-2", style="background-color:#007bff;"><i class="fa-regular fa-newspaper"></i> Paper</a>
                                    </div>
                                    <div class="btn">
                                        <a href="#" class="btn btn-primary btn-lg mr-2", style="background-color:#007bff;"><i class="fa-solid fa-person-chalkboard"></i> Presentation</a>
                                    </div>
                                </div> 
                              </div>
