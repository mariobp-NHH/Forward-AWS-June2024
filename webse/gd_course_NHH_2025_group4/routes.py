...
from webse.gd_course_NHH_2025_group4.forms import RegistrationForm, LoginForm, BusForm, CarForm, PlaneForm, FerryForm, MotorbikeForm, TrainForm, WalkForm
...
gd_course_NHH_2025_group4=Blueprint('gd_course_NHH_2025_group4',__name__)

@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/home')
def home_home():
  return render_template('gd_course/NHH_2025_group4/home.html')

@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/methodology')
def methodology_home():
  return render_template('gd_course/NHH_2025_group4/methodology.html', title='methodology')

@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/register', methods=['GET','POST'])
def register():
  form = RegistrationForm()
  if current_user.is_authenticated:
        return redirect(url_for('gd_course_NHH_2025_group4.home_home'))
  if form.validate_on_submit():
      user_hashed_password = bcrypt.generate_password_hash(form.password.data).decode('utf-8')
      user = User(username=form.username.data, email=form.email.data, password=user_hashed_password, institution='NHH_2025_group4')
      db.session.add(user)
      db.session.commit()
      flash('Your account has been created! Now, you are able to login!', 'success')
      return redirect(url_for('gd_course_NHH_2025_group4.login'))
  return render_template('gd_course/NHH_2025_group4/users/register.html', title='register', form=form)

@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/login', methods=['GET','POST'])
def login():
  form = LoginForm()
  if current_user.is_authenticated:
        return redirect(url_for('gd_course_NHH_2025_group4.home_home'))
  if form.validate_on_submit():
    ...
    if user and bcrypt.check_password_hash(user.password, form.password.data):
        ...
        return redirect(next_page) if next_page else redirect(url_for('gd_course_NHH_2025_group4.home_home'))
    else:
        flash('Login Unsuccessful. Please check email and password!', 'danger')
  return render_template('gd_course/NHH_2025_group4/users/login.html', title='login', form=form)

@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/logout')
def logout():
    logout_user()
    return redirect(url_for('gd_course_NHH_2025_group4.home_home'))
...
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app')
@login_required
def carbon_app_home():
    return render_template('gd_course/NHH_2025_group4/carbon_app/carbon_app.html', title='Carbon App')

#New entry bus
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/new_entry_bus', methods=['GET','POST'])
@login_required
def new_entry_bus():
    form = BusForm()
    if form.validate_on_submit():
        ...
        emissions = EmissionsGD(kms=kms, transport=transport, fuel=fuel, co2=co2, total=total, student='NHH_2025_group4', institution='NHH_2025_group4', year=2025, author=current_user)
        db.session.add(emissions)
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2025_group4.your_data'))
    return render_template('gd_course/NHH_2025_group4/carbon_app/new_entry_bus.html', title='new entry bus', form=form)

#New entry car
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/new_entry_car', methods=['GET','POST'])
@login_required
def new_entry_car():
    form = CarForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2025_group4.your_data'))
    return render_template('gd_course/NHH_2025_group4/carbon_app/new_entry_car.html', title='new entry car', form=form)

#New entry plane
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/new_entry_plane', methods=['GET','POST'])
@login_required
def new_entry_plane():
    form = PlaneForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2025_group4.your_data'))
    return render_template('gd_course/NHH_2025_group4/carbon_app/new_entry_plane.html', title='new entry plane', form=form)

#New entry ferry
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/new_entry_ferry', methods=['GET','POST'])
@login_required
def new_entry_ferry():
    form = FerryForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2025_group4.your_data'))
    return render_template('gd_course/NHH_2025_group4/carbon_app/new_entry_ferry.html', title='new entry ferry', form=form)


#New entry motorbike
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/new_entry_motorbike', methods=['GET','POST'])
@login_required
def new_entry_motorbike():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2025_group4.your_data'))
    return render_template('gd_course/NHH_2025_group4/carbon_app/new_entry_motorbike.html', title='new entry motorbike', form=form)

#New entry train
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/new_entry_train', methods=['GET','POST'])
@login_required
def new_entry_train():
    form = TrainForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2025_group4.your_data'))
    return render_template('gd_course/NHH_2025_group4/carbon_app/new_entry_train.html', title='new entry train', form=form)


#New entry bicycle
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/new_entry_bicycle', methods=['GET','POST'])
@login_required
def new_entry_bicycle():
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2025_group4.your_data'))
    return render_template('gd_course/NHH_2025_group4/carbon_app/new_entry_bicycle.html', title='new entry bicycle', form=form)

#New entry walk
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/new_entry_walk', methods=['GET','POST'])
@login_required
def new_entry_walk():
    form = WalkForm()
    if form.validate_on_submit():
        ...
        db.session.commit()
        return redirect(url_for('gd_course_NHH_2025_group4.your_data'))
    return render_template('gd_course/NHH_2025_group4/carbon_app/new_entry_walk.html', title='new entry walk', form=form)

#Your data
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/your_data')
@login_required
def your_data():
    #Table
    entries = EmissionsGD.query.filter_by(author=current_user). \
        filter(EmissionsGD.date> (datetime.now() - timedelta(days=5))).\
        filter(EmissionsGD.institution=='NHH_2025_group4').\
    ...
    return render_template('gd_course/NHH_2025_group4/carbon_app/your_data.html', title='your_data', entries=entries,
...
#Delete emission
@gd_course_NHH_2025_group4.route('/green_digitalization_course/NHH/2025/group4/carbon_app/delete-emission/<int:entry_id>')
